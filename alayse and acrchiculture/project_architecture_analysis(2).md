...
| `api/cron/` (21 cron jobs via 12 triggers)        | ✅ Core                        | Operational automation                                                                                                                                                                                                                |
...
| **[worker-cron-handler.ts](/worker-cron-handler.ts) (16 KB / 324 lines)** | Top-level cron handler dispatching 21 cron jobs across 12 cron triggers — mixes operational automation, billing, compliance retention, and platform maintenance in one control surface. Must stay in sync with `wrangler.toml` (see §5.1)                                                                                                                                                                                |
