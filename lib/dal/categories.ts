...
/** Columns safe to select (excludes 'description' which may not exist in older DB schemas) */
const LIST_COLUMNS = "id, site_id, name, slug, taxonomy_type, created_at" as const;
