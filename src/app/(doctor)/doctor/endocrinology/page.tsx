...
import { Droplets, Plus, Save, TrendingUp, AlertTriangle, Pill, ClipboardList } from "lucide-react";
...
import {
  ...
  fetchHormoneLevels,
  createHormoneLevel,
  fetchDiabetesManagement,
  createDiabetesManagement,
  type BloodSugarReadingView,
...
export default function EndocrinologyPage() {
  ...
  const handleAddSugar = async () => {
    ...
    const newId = await createBloodSugarReading({
      ...
      reading_type: sugarForm.readingType,
      unit: sugarForm.unit,
  ...
  const handleAddHormone = async () => {
    ...
    const newId = await createHormoneLevel({
      ...
      patient_id: user.id,
      doctor_id: user.id,
      hormone_name: hormoneForm.hormoneName,
      value: parseFloat(hormoneForm.value),
      unit: hormoneForm.unit,
      reference_range: hormoneForm.referenceRange,
      is_abnormal: hormoneForm.isAbnormal,
      notes: hormoneForm.notes,
    });
    if (newId) {
      setHormones((prev) => [
        {
          ...
          value: parseFloat(hormoneForm.value),
          unit: hormoneForm.unit,
          referenceRange: hormoneForm.referenceRange,
          isAbnormal: hormoneForm.isAbnormal,
          notes: hormoneForm.notes,
        },
        ...prev,
      ]);
  ...
  const handleAddDiabetes = async () => {
    ...
    const newId = await createDiabetesManagement({
      ...
      diet_plan: diabetesForm.dietPlan,
      exercise_plan: diabetesForm.exercisePlan,
      monitoring_frequency: diabetesForm.monitoringFrequency,
      notes: diabetesForm.notes,
    });
    if (newId) {
      setDiabetes((prev) => [
        {
          ...
          medications: [],
          dietPlan: diabetesForm.dietPlan,
    ...
    <div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-4">
              <Card>
                <CardContent className="p-4 text-center">
                  ...
                  <p
                    className={`text-xs font-medium ${glucoseCategory(sugars[0].glucoseLevel, sugars[0].readingType).color}`}
                  >
                ...
                <Card key={h.id}>
                  <CardContent className="p-4">
                    ...
                    <div className="grid grid-cols-3 gap-3 text-sm">
                      <div>
                        <span className="text-muted-foreground">Value:</span> {h.value} {h.unit}
                      </div>
                      {h.referenceRange && (
                        <div>
                ...
                <Card key={d.id}>
                  <CardHeader className="pb-2">
                    <div className="flex items-center justify-between">
                      ...
                      {d.currentHba1c !== null && (
                        <Badge
                          variant={d.currentHba1c <= d.targetHba1c ? "default" : "destructive"}
                        >
      ...
      <Dialog open={showSugarForm} onOpenChange={setShowSugarForm}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>Add Blood Sugar Reading</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 mt-4">
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="space-y-2">
                <Label>Type</Label>
                <Select
                  value={sugarForm.readingType}
                  onValueChange={(v) => setSugarForm((p) => ({ ...p, readingType: v }))}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => setSugarForm((p) => ({ ...p, unit: v }))}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
            ...
            <div className="flex gap-2 justify-end">
              <Button variant="outline" onClick={() => setShowSugarForm(false)}>
                Cancel
              </Button>
              <Button onClick={handleAddSugar}>
      ...
      <Dialog open={showHormoneForm} onOpenChange={setShowHormoneForm}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>Add Hormone Level</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 mt-4">
            <div className="space-y-2">
              <Label>Hormone Name</Label>
              <Select
                value={hormoneForm.hormoneName}
                onValueChange={(v) => setHormoneForm((p) => ({ ...p, hormoneName: v }))}
              >
                <SelectTrigger>
                  <SelectValue placeholder="Select hormone" />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="space-y-2">
                ...
                <Input
                  placeholder="0.5-4.5"
                  value={hormoneForm.referenceRange}
                  onChange={(e) =>
                    setHormoneForm((p) => ({ ...p, referenceRange: e.target.value }))
                  }
                />
              </div>
            </div>
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                id="abnormal"
                checked={hormoneForm.isAbnormal}
            ...
            <div className="flex gap-2 justify-end">
              <Button variant="outline" onClick={() => setShowHormoneForm(false)}>
                Cancel
              </Button>
              <Button onClick={handleAddHormone}>
                <Save className="h-4 w-4 mr-1" /> Save
              </Button>
            </div>
          </div>
      ...
      <Dialog open={showDiabetesForm} onOpenChange={setShowDiabetesForm}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle>New Diabetes Management Plan</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 mt-4">
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-2">
                ...
                <Select
                  value={diabetesForm.diabetesType}
                  onValueChange={(v) => setDiabetesForm((p) => ({ ...p, diabetesType: v }))}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Input
                  type="date"
                  value={diabetesForm.diagnosisDate}
                  onChange={(e) =>
                    setDiabetesForm((p) => ({ ...p, diagnosisDate: e.target.value }))
                  }
                />
              </div>
            </div>
            <div className="grid grid-cols-3 gap-3">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  step="0.1"
                  placeholder="7.0"
                  value={diabetesForm.currentHba1c}
              ...
              <div className="space-y-2">
                ...
                <Input
                  type="number"
                  step="0.1"
                  value={diabetesForm.targetHba1c}
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={diabetesForm.monitoringFrequency}
                  onValueChange={(v) => setDiabetesForm((p) => ({ ...p, monitoringFrequency: v }))}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                value={diabetesForm.exercisePlan}
            ...
            <div className="flex gap-2 justify-end">
              <Button variant="outline" onClick={() => setShowDiabetesForm(false)}>
                Cancel
              </Button>
              <Button onClick={handleAddDiabetes}>
                <Save className="h-4 w-4 mr-1" /> Save
              </Button>
            </div>
          </div>
