...
const stats = [
  ...
  { icon: Dumbbell, label: "Exercise Programs", value: "0", color: "text-green-600" },
  { icon: ClipboardList, label: "Sessions This Week", value: "0", color: "text-orange-600" },
  { icon: Camera, label: "Progress Photos", value: "0", color: "text-purple-600" },
];
