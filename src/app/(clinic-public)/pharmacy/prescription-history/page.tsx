...
export default function PrescriptionHistoryPage() {
  ...
  useEffect(() => {
    ...
    fetchPrescriptionsClient(tenant?.clinicId ?? "")
      .then((d) => {
        if (!controller.signal.aborted) setPrescriptions(d);
      })
      .catch((err) => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-2">Prescription History</h1>
      <p className="text-muted-foreground mb-8">Track the status of your uploaded prescriptions</p>
                    ...
                    <div className="flex-1">
                      ...
                      {rx.status === "partially-ready" && totalItems > 0 && (
                        <div className="flex items-center gap-2 text-sm text-orange-600 mb-2">
                          ...
                          <span>
                            {availableCount} of {totalItems} items ready
                          </span>
                        </div>
                      )}
