...
export const CLINIC_CATEGORIES: ClinicCategory[] = [
  ...
  },
  {
    ...
    name_fr: "Vétérinaire",
    name_ar: "بيطري",
    description_fr: "Cliniques vétérinaires et soins pour animaux",
    icon: "PawPrint",
...
const CLINIC_TYPES: ClinicTypeEntry[] = [
  ...
  // ---- PARA-MEDICAL ----
  {
    type_key: "physiotherapy",
    name_fr: "Kinésithérapie",
    name_ar: "العلاج الطبيعي",
    category: "para_medical",
    icon: "Dumbbell",
  },
  {
    type_key: "speech_therapy",
    name_fr: "Orthophonie",
    name_ar: "النطق والتخاطب",
    category: "para_medical",
    icon: "MessageCircle",
  },
  {
    type_key: "nutrition",
    name_fr: "Diététique et Nutrition",
    name_ar: "التغذية",
    category: "para_medical",
    icon: "Salad",
  },
  ...
  {
    type_key: "medical_lab",
    name_fr: "Laboratoire d'Analyses",
    name_ar: "مختبر التحاليل الطبية",
    category: "diagnostic",
    icon: "TestTube",
  },
  {
    type_key: "medical_imaging",
    name_fr: "Imagerie Médicale",
  ...
  {
    type_key: "pathology",
    name_fr: "Anatomie Pathologique",
    name_ar: "التشريح المرضي",
    category: "diagnostic",
    icon: "Microscope",
  },
  ...
  {
    type_key: "parapharmacy",
    name_fr: "Parapharmacie",
    name_ar: "شبه صيدلية",
    category: "pharmacy_retail",
    icon: "ShoppingBag",
  },
  {
    type_key: "medical_equipment",
  ...
  {
    type_key: "orthopedic_supply",
    name_fr: "Orthopédie et Appareillage",
    name_ar: "تقويم العظام والأجهزة",
    category: "pharmacy_retail",
    icon: "Cog",
  },
  ...
  // ---- CLINICS & CENTERS ----
  {
    type_key: "dental_clinic",
    name_fr: "Cabinet Dentaire",
    name_ar: "عيادة الأسنان",
    category: "clinics_centers",
    icon: "Smile",
  },
  {
    type_key: "polyclinic",
    name_fr: "Polyclinique",
    name_ar: "عيادة متعددة التخصصات",
    category: "clinics_centers",
    icon: "Building2",
  },
  {
    type_key: "medical_center",
  ...
  },
  {
    ...
    name_fr: "Centre d'Hémodialyse",
    name_ar: "مركز غسيل الكلى",
    category: "clinics_centers",
    icon: "Droplet",
  },
  {
    type_key: "rehabilitation",
    name_fr: "Centre de Rééducation",
    name_ar: "مركز إعادة التأهيل",
    category: "clinics_centers",
    icon: "StretchVertical",
  },
  {
    type_key: "aesthetic_clinic",
    name_fr: "Clinique Esthétique",
    name_ar: "عيادة التجميل",
    category: "clinics_centers",
    icon: "Sparkles",
  },
  ...
  // ---- VETERINARY ----
  {
    type_key: "vet_general",
    name_fr: "Vétérinaire Généraliste",
    name_ar: "طبيب بيطري عام",
    category: "veterinary",
    icon: "PawPrint",
    vertical_id: "veterinary",
  },
  {
    type_key: "vet_specialist",
    name_fr: "Vétérinaire Spécialiste",
    name_ar: "طبيب بيطري متخصص",
    category: "veterinary",
    icon: "Stethoscope",
    vertical_id: "veterinary",
  },
  {
    type_key: "vet_emergency",
    name_fr: "Urgences Vétérinaires",
    name_ar: "طوارئ بيطرية",
    category: "veterinary",
    icon: "Siren",
    vertical_id: "veterinary",
  },
  {
    type_key: "pet_grooming",
    name_fr: "Toilettage Animaux",
    name_ar: "تنظيف الحيوانات",
    category: "veterinary",
    icon: "Scissors",
    vertical_id: "veterinary",
  },
  ...
  // ---- RESTAURANT ----
  {
    type_key: "restaurant_traditional",
  ...
  {
    type_key: "restaurant_cafe",
    name_fr: "Café & Salon de Thé",
  ...
  {
    type_key: "restaurant_patisserie",
    name_fr: "Pâtisserie & Boulangerie",
    name_ar: "حلويات ومخبزة",
    category: "restaurant",
    icon: "CakeSlice",
    vertical_id: "restaurant",
  },
  {
    type_key: "restaurant_traiteur",
    name_fr: "Traiteur & Événementiel",
    name_ar: "تموين ومناسبات",
    category: "restaurant",
    icon: "PartyPopper",
    vertical_id: "restaurant",
  },
