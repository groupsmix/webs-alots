...
export const translations = {
  fr: {
    ...
    "specialty.veterinarian": "Vétérinaire",

    // Veterinary terminology
    "vet.patient": "Animal",
    "vet.client": "Propriétaire",
    "vet.provider": "Vétérinaire",
    "vet.appointment": "Consultation",
    "vet.location": "Clinique vétérinaire",
    "vet.petProfiles": "Profils des animaux",
    "vet.petName": "Nom de l'animal",
    "vet.species": "Espèce",
    "vet.breed": "Race",
    "vet.weight": "Poids (kg)",
    "vet.dateOfBirth": "Date de naissance",
    "vet.owner": "Propriétaire",
    "vet.addPet": "Ajouter un animal",
    "vet.editPet": "Modifier l'animal",
    "vet.deletePet": "Supprimer l'animal",
    "vet.vaccination": "Vaccination",
    "vet.vaccinationHistory": "Historique des vaccinations",
    "vet.nextVaccination": "Prochaine vaccination",

    // Restaurant terminology
    "restaurant.menu": "Menu",
    "restaurant.menuItems": "Plats",
    "restaurant.tables": "Tables",
    "restaurant.reservations": "Réservations",
    "restaurant.orders": "Commandes",
    "restaurant.guests": "Convives",
    "restaurant.partySize": "Nombre de convives",
    "restaurant.specialRequests": "Demandes spéciales",
    "restaurant.allergens": "Allergènes",
    "restaurant.isHalal": "Halal",
    "restaurant.tableZone": "Zone",
    "restaurant.capacity": "Capacité",
    "restaurant.qrOrder": "Commander par QR",
    "restaurant.floorPlan": "Plan de salle",
    "restaurant.addItem": "Ajouter un plat",
    "restaurant.editItem": "Modifier le plat",
    ...
    "mfa.setupDesc": "Scannez le QR code avec votre application d'authentification (Google Authenticator, Authy, etc.)",
    "mfa.verifyTitle": "Vérification en deux étapes",
    "mfa.verifyDesc": "Entrez le code à 6 chiffres de votre application d'authentification.",
    ...
    "mfa.enabled": "2FA activée",
    "mfa.disabled": "2FA désactivée",
    "mfa.enable": "Activer la 2FA",
    "mfa.disable": "Désactiver la 2FA",
    "mfa.disableConfirm": "Êtes-vous sûr de vouloir désactiver la 2FA ?",
    "mfa.backupCodes": "Codes de secours",
    "mfa.backupCodesDesc": "Conservez ces codes en lieu sûr. Chaque code ne peut être utilisé qu'une seule fois.",
    "mfa.backupCodePlaceholder": "Entrez un code de secours",
    "mfa.useBackupCode": "Utiliser un code de secours",
    "mfa.useTOTP": "Utiliser l'application d'authentification",
    "mfa.regenerateBackupCodes": "Régénérer les codes de secours",
    "mfa.downloadCodes": "Télécharger les codes",
    "mfa.copyCodes": "Copier les codes",
    "mfa.scanQR": "Scannez ce QR code",
    "mfa.manualEntry": "Ou entrez ce code manuellement",
    "mfa.copySecret": "Copier le secret",
    "mfa.setupComplete": "Configuration terminée !",
    "mfa.setupCompleteDesc": "L'authentification à deux facteurs est maintenant activée pour votre compte.",
    "mfa.goToDashboard": "Aller au tableau de bord",
    "mfa.settings": "Paramètres 2FA",
    "mfa.settingsDesc": "Gérez l'authentification à deux facteurs pour sécuriser votre compte.",
    "mfa.required": "La vérification en deux étapes est requise pour accéder à cette section.",
  ...
  ar: {
    ...
    "specialty.veterinarian": "طبيب بيطري",

    // Veterinary terminology
    "vet.patient": "حيوان",
    "vet.client": "صاحب الحيوان",
    "vet.provider": "طبيب بيطري",
    "vet.appointment": "استشارة",
    "vet.location": "عيادة بيطرية",
    "vet.petProfiles": "ملفات الحيوانات",
    "vet.petName": "اسم الحيوان",
    "vet.species": "النوع",
    "vet.breed": "السلالة",
    "vet.weight": "الوزن (كغ)",
    "vet.dateOfBirth": "تاريخ الميلاد",
    "vet.owner": "صاحب الحيوان",
    "vet.addPet": "إضافة حيوان",
    "vet.editPet": "تعديل الحيوان",
    "vet.deletePet": "حذف الحيوان",
    "vet.vaccination": "تلقيح",
    "vet.vaccinationHistory": "سجل التلقيحات",
    "vet.nextVaccination": "التلقيح القادم",

    // Restaurant terminology
    "restaurant.menu": "قائمة الطعام",
    "restaurant.menuItems": "الأطباق",
    "restaurant.tables": "الطاولات",
    "restaurant.reservations": "الحجوزات",
    "restaurant.orders": "الطلبات",
    "restaurant.guests": "الضيوف",
    "restaurant.partySize": "عدد الضيوف",
    "restaurant.specialRequests": "طلبات خاصة",
    "restaurant.allergens": "مسببات الحساسية",
    "restaurant.isHalal": "حلال",
    "restaurant.tableZone": "المنطقة",
    "restaurant.capacity": "السعة",
    "restaurant.qrOrder": "اطلب عبر QR",
    "restaurant.floorPlan": "مخطط القاعة",
    "restaurant.addItem": "إضافة طبق",
    "restaurant.editItem": "تعديل الطبق",
    "restaurant.category": "الفئة",
    "restaurant.price": "السعر",
    "restaurant.available": "متاح",
    ...
    "mfa.setupTitle": "إعداد المصادقة الثنائية",
    "mfa.setupDesc": "امسح رمز QR بتطبيق المصادقة (Google Authenticator، Authy، إلخ.)",
    "mfa.verifyTitle": "التحقق بخطوتين",
    "mfa.verifyDesc": "أدخل الرمز المكون من 6 أرقام من تطبيق المصادقة.",
    "mfa.code": "رمز التحقق",
    "mfa.codePlaceholder": "000000",
    "mfa.verify": "تحقق",
    "mfa.verifying": "جاري التحقق...",
    "mfa.invalidCode": "رمز غير صالح. يرجى المحاولة مرة أخرى.",
    "mfa.enabled": "المصادقة الثنائية مفعّلة",
    "mfa.disabled": "المصادقة الثنائية معطّلة",
    "mfa.enable": "تفعيل المصادقة الثنائية",
    "mfa.disable": "تعطيل المصادقة الثنائية",
    "mfa.disableConfirm": "هل أنت متأكد من تعطيل المصادقة الثنائية؟",
    "mfa.backupCodes": "رموز الاسترداد",
    "mfa.backupCodesDesc": "احفظ هذه الرموز في مكان آمن. كل رمز يمكن استخدامه مرة واحدة فقط.",
    "mfa.backupCodePlaceholder": "أدخل رمز الاسترداد",
    "mfa.useBackupCode": "استخدام رمز الاسترداد",
    "mfa.useTOTP": "استخدام تطبيق المصادقة",
    "mfa.regenerateBackupCodes": "إعادة إنشاء رموز الاسترداد",
    "mfa.downloadCodes": "تحميل الرموز",
    "mfa.copyCodes": "نسخ الرموز",
    "mfa.scanQR": "امسح رمز QR هذا",
    "mfa.manualEntry": "أو أدخل هذا الرمز يدويًا",
    "mfa.copySecret": "نسخ السر",
    "mfa.setupComplete": "اكتمل الإعداد!",
    "mfa.setupCompleteDesc": "تم تفعيل المصادقة الثنائية لحسابك الآن.",
    "mfa.goToDashboard": "الذهاب إلى لوحة التحكم",
    "mfa.settings": "إعدادات المصادقة الثنائية",
    "mfa.settingsDesc": "إدارة المصادقة الثنائية لتأمين حسابك.",
    "mfa.required": "التحقق بخطوتين مطلوب للوصول إلى هذا القسم.",
  ...
  en: {
    ...
    "specialty.veterinarian": "Veterinarian",

    // Veterinary terminology
    "vet.patient": "Animal",
    "vet.client": "Owner",
    "vet.provider": "Veterinarian",
    "vet.appointment": "Consultation",
    "vet.location": "Veterinary Clinic",
    "vet.petProfiles": "Pet Profiles",
    "vet.petName": "Pet Name",
    "vet.species": "Species",
    "vet.breed": "Breed",
    "vet.weight": "Weight (kg)",
    "vet.dateOfBirth": "Date of Birth",
    "vet.owner": "Owner",
    "vet.addPet": "Add Pet",
    "vet.editPet": "Edit Pet",
    "vet.deletePet": "Delete Pet",
    "vet.vaccination": "Vaccination",
    "vet.vaccinationHistory": "Vaccination History",
    "vet.nextVaccination": "Next Vaccination",
    ...
    "restaurant.specialRequests": "Special Requests",
    "restaurant.allergens": "Allergens",
    "restaurant.isHalal": "Halal",
    "restaurant.tableZone": "Zone",
    "restaurant.capacity": "Capacity",
    "restaurant.qrOrder": "Order via QR",
    ...
    "mfa.setupDesc": "Scan the QR code with your authenticator app (Google Authenticator, Authy, etc.)",
    "mfa.verifyTitle": "Two-Step Verification",
    "mfa.verifyDesc": "Enter the 6-digit code from your authenticator app.",
    ...
    "mfa.disableConfirm": "Are you sure you want to disable 2FA?",
    "mfa.backupCodes": "Backup codes",
    "mfa.backupCodesDesc": "Keep these codes in a safe place. Each code can only be used once.",
    "mfa.backupCodePlaceholder": "Enter a backup code",
    "mfa.useBackupCode": "Use a backup code",
    "mfa.useTOTP": "Use authenticator app",
    "mfa.regenerateBackupCodes": "Regenerate backup codes",
    "mfa.downloadCodes": "Download codes",
    "mfa.copyCodes": "Copy codes",
    "mfa.scanQR": "Scan this QR code",
    "mfa.manualEntry": "Or enter this code manually",
    "mfa.copySecret": "Copy secret",
    "mfa.setupComplete": "Setup complete!",
    "mfa.setupCompleteDesc": "Two-factor authentication is now enabled for your account.",
    "mfa.goToDashboard": "Go to dashboard",
    "mfa.settings": "2FA Settings",
    "mfa.settingsDesc": "Manage two-factor authentication to secure your account.",
    "mfa.required": "Two-step verification is required to access this section.",
