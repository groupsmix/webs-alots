...
export const DIRECTORY_SPECIALTIES: DirectorySpecialty[] = [
  {
    ...
    description: "Consultations de médecine générale et suivi médical",
  },
  {
    name: "Dentist",
    slug: "dentiste",
    nameAr: "طبيب أسنان",
    nameFr: "Dentiste",
    description: "Soins dentaires, orthodontie et chirurgie buccale",
  },
  {
    name: "Pediatrician",
    slug: "pediatre",
    nameAr: "طبيب أطفال",
    nameFr: "Pédiatre",
    description: "Suivi médical des nourrissons, enfants et adolescents",
  },
  {
    name: "Gynecologist",
    slug: "gynecologue",
    nameAr: "طبيب نساء وتوليد",
    nameFr: "Gynécologue",
    description: "Gynécologie, obstétrique et suivi de grossesse",
  },
  {
    name: "Ophthalmologist",
    slug: "ophtalmologue",
    nameAr: "طبيب عيون",
    nameFr: "Ophtalmologue",
    description: "Soins des yeux, examens de la vue et chirurgie ophtalmique",
  },
  {
    name: "Cardiologist",
    slug: "cardiologue",
  ...
  },
  {
    ...
    nameAr: "طبيب جلد",
    nameFr: "Dermatologue",
    description: "Soins de la peau, dermatologie esthétique et allergies cutanées",
  },
  {
    name: "Orthopedist",
    slug: "orthopediste",
    nameAr: "طبيب عظام",
    nameFr: "Orthopédiste",
    description: "Traumatologie, chirurgie orthopédique et rhumatologie",
  },
  {
    name: "Neurologist",
    slug: "neurologue",
  ...
  },
  {
    ...
    nameAr: "طبيب نفسي",
    nameFr: "Psychiatre",
    description: "Santé mentale, troubles psychologiques et thérapies",
  },
  {
    name: "Physiotherapist",
    slug: "kinesitherapeute",
    nameAr: "معالج طبيعي",
    nameFr: "Kinésithérapeute",
    description: "Rééducation fonctionnelle et kinésithérapie",
  },
  {
    name: "Radiologist",
    slug: "radiologue",
    nameAr: "طبيب أشعة",
    nameFr: "Radiologue",
    description: "Imagerie médicale, radiologie et échographie",
  },
  {
    name: "Nutritionist",
    slug: "nutritionniste",
    nameAr: "أخصائي تغذية",
    nameFr: "Nutritionniste",
    description: "Nutrition, diététique et suivi alimentaire",
  },
  {
    name: "ENT Specialist",
    slug: "orl",
    nameAr: "طبيب أنف أذن حنجرة",
    nameFr: "ORL",
    description: "Oto-rhino-laryngologie — nez, oreilles et gorge",
  },
  {
    name: "Urologist",
    slug: "urologue",
    nameAr: "طبيب مسالك بولية",
    nameFr: "Urologue",
    description: "Appareil urinaire et troubles urologiques",
  },
  {
    name: "Pulmonologist",
    slug: "pneumologue",
    nameAr: "طبيب رئة",
    nameFr: "Pneumologue",
    description: "Maladies respiratoires et pneumologie",
  },
  {
    name: "Endocrinologist",
    slug: "endocrinologue",
    nameAr: "طبيب غدد",
    nameFr: "Endocrinologue",
    description: "Diabète, thyroïde et troubles hormonaux",
  },
  {
    name: "Rheumatologist",
    slug: "rhumatologue",
    nameAr: "طبيب روماتيزم",
    nameFr: "Rhumatologue",
    description: "Rhumatismes, arthrose et maladies articulaires",
  },
  {
    name: "Gastroenterologist",
    slug: "gastro-enterologue",
    nameAr: "طبيب جهاز هضمي",
    nameFr: "Gastro-entérologue",
    description: "Maladies de l'appareil digestif et hépatologie",
  },
  {
    name: "Nephrologist",
    slug: "nephrologue",
    nameAr: "طبيب كلى",
    nameFr: "Néphrologue",
    description: "Maladies rénales et dialyse",
  },
  {
    name: "Pharmacist",
    slug: "pharmacien",
    nameAr: "صيدلي",
    nameFr: "Pharmacien",
    description: "Pharmacie, conseil pharmaceutique et parapharmacie",
  },
  {
    name: "Optician",
    slug: "opticien",
    nameAr: "بصري",
    nameFr: "Opticien",
    description: "Lunettes, lentilles de contact et optique",
  },
  {
    name: "Speech Therapist",
    slug: "orthophoniste",
    nameAr: "أخصائي نطق",
    nameFr: "Orthophoniste",
    description: "Rééducation de la parole et du langage",
  },
  {
    name: "Psychologist",
    slug: "psychologue",
    nameAr: "أخصائي نفسي",
    nameFr: "Psychologue",
    description: "Accompagnement psychologique et thérapies comportementales",
  },
];
