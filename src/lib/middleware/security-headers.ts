...
export function applyAllSecurityHeaders(
  ...
  // COOP: same-origin-allow-popups preserves OAuth popup flows while
  // still preventing cross-origin window references from leaked navigations.
  // COEP: credentialless allows third-party iframes that opt-in via CORS.
  // CORP: same-origin restricts who can embed this resource cross-origin.
