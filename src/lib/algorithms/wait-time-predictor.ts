 ...
 */
export function predictWaitTime(state: QueueState, positionInQueue?: number): WaitTimeEstimate {
  // If no position provided, assume patient is at the end of the line
  const effectivePosition =
    positionInQueue !== undefined ? positionInQueue : state.patientsInQueue + state.walkInsInQueue;
