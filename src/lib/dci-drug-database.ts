...
export const DCI_DRUG_DATABASE: DCIDrug[] = [
  // ── Analgesics / Pain ──
  {
    id: "d001",
    dci: "Paracétamol",
    brands: ["Doliprane", "Efferalgan", "Dafalgan"],
    category: "analgesic",
    forms: ["Comprimé", "Sachet", "Suppositoire", "Sirop"],
    strengths: ["500mg", "1g", "100mg", "150mg", "200mg", "300mg"],
  ...
  },
  {
    ...
    forms: ["Comprimé", "Gélule", "Sirop", "Gel"],
  ...
  },
  {
    id: "d003",
    dci: "Diclofénac",
    brands: ["Voltarène", "Cataflam"],
    category: "anti-inflammatory",
    forms: ["Comprimé", "Gel", "Suppositoire", "Injectable"],
    strengths: ["25mg", "50mg", "75mg", "100mg", "1%"],
    requiresPrescription: true,
  },
  {
    id: "d004",
    dci: "Tramadol",
    brands: ["Tramal", "Contramal", "Topalgic"],
    category: "analgesic",
  ...
  {
    id: "d005",
    dci: "Codéine + Paracétamol",
    brands: ["Codoliprane", "Dafalgan Codéiné"],
    category: "analgesic",
    forms: ["Comprimé"],
    strengths: ["400mg/20mg", "500mg/30mg"],
    requiresPrescription: true,
  },
  {
    id: "d006",
    dci: "Acide Acétylsalicylique",
    brands: ["Aspro", "Aspégic", "Kardégic"],
    category: "analgesic",
    forms: ["Comprimé", "Sachet"],
    strengths: ["75mg", "100mg", "250mg", "500mg", "1g"],
    requiresPrescription: false,
  },
  {
    id: "d007",
    dci: "Kétoprofène",
    brands: ["Profénid", "Bi-Profénid"],
    category: "anti-inflammatory",
    forms: ["Comprimé", "Gélule", "Gel", "Injectable"],
    strengths: ["50mg", "100mg", "150mg LP", "2.5%"],
    requiresPrescription: true,
  },
  {
    id: "d008",
    dci: "Naproxène",
    brands: ["Naprosyne", "Apranax"],
    category: "anti-inflammatory",
    forms: ["Comprimé", "Sachet"],
    strengths: ["250mg", "500mg", "550mg"],
    requiresPrescription: true,
  },
  {
    id: "d009",
    dci: "Morphine",
    brands: ["Skénan", "Actiskénan"],
    category: "analgesic",
    forms: ["Gélule LP", "Gélule", "Injectable"],
    strengths: ["10mg", "30mg", "60mg", "100mg"],
    requiresPrescription: true,
  },
  {
    id: "d010",
  ...
  // ── Antibiotics ──
  {
    id: "d011",
    dci: "Amoxicilline",
    brands: ["Clamoxyl", "Amoxil", "Ospamox"],
    category: "antibiotic",
    forms: ["Gélule", "Comprimé dispersible", "Sirop", "Injectable"],
  ...
  },
  {
    ...
    brands: ["Augmentin", "Amoclav"],
    category: "antibiotic",
    forms: ["Comprimé", "Sachet", "Sirop", "Injectable"],
    strengths: ["500mg/62.5mg", "1g/125mg", "100mg/12.5mg/mL"],
    requiresPrescription: true,
  },
  {
    id: "d013",
    dci: "Azithromycine",
    brands: ["Zithromax", "Azadose"],
    category: "antibiotic",
  ...
  },
  {
    id: "d014",
    dci: "Ciprofloxacine",
    brands: ["Ciproxine", "Cipro"],
    category: "antibiotic",
    forms: ["Comprimé", "Injectable", "Collyre"],
    strengths: ["250mg", "500mg", "750mg", "0.3%"],
    requiresPrescription: true,
  },
  {
    id: "d015",
    ...
    brands: ["Flagyl"],
    category: "antibiotic",
    forms: ["Comprimé", "Ovule", "Injectable", "Gel"],
  ...
  },
  {
    id: "d021",
    dci: "Cotrimoxazole",
    brands: ["Bactrim", "Eusaprim"],
    category: "antibiotic",
    forms: ["Comprimé", "Sirop"],
    strengths: ["400mg/80mg", "800mg/160mg"],
    requiresPrescription: true,
  },
  {
    id: "d022",
  ...
  },
  {
    ...
    brands: ["Gentalline"],
    category: "antibiotic",
    forms: ["Injectable", "Collyre", "Pommade"],
    strengths: ["10mg", "40mg", "80mg", "0.3%"],
    requiresPrescription: true,
  },
  {
    id: "d025",
  ...
  },
  {
    ...
    brands: ["Diamicron"],
    category: "antidiabetic",
    forms: ["Comprimé", "Comprimé LM"],
    strengths: ["30mg LM", "60mg LM", "80mg"],
    requiresPrescription: true,
  },
  {
    id: "d028",
  ...
  },
  {
    ...
    category: "antidiabetic",
    forms: ["Stylo injectable"],
    strengths: ["100 UI/mL", "300 UI/mL"],
    requiresPrescription: true,
  },
  {
    id: "d031",
    dci: "Insuline Rapide",
    brands: ["Novorapid", "Humalog", "Apidra"],
    category: "antidiabetic",
    forms: ["Stylo injectable", "Flacon"],
    strengths: ["100 UI/mL"],
    requiresPrescription: true,
  },
  {
  ...
  },
  {
    ...
    brands: ["Adalate"],
    category: "antihypertensive",
    forms: ["Comprimé LP", "Capsule"],
    strengths: ["10mg", "20mg LP", "30mg LP"],
    requiresPrescription: true,
  },
  {
    id: "d043",
  ...
  },
  {
    ...
    brands: ["Spasfon"],
    category: "gastrointestinal",
    forms: ["Comprimé", "Suppositoire", "Injectable"],
    strengths: ["80mg"],
    requiresPrescription: false,
  },
  {
  ...
  // ── Corticosteroids ──
  {
    ...
    forms: ["Comprimé", "Comprimé orodispersible", "Solution buvable"],
    strengths: ["5mg", "20mg"],
    requiresPrescription: true,
  },
  {
  ...
  },
  {
    id: "d064",
    dci: "Bétaméthasone",
    brands: ["Célestène", "Diprostène"],
    category: "corticosteroid",
    forms: ["Comprimé", "Gouttes", "Injectable"],
    strengths: ["0.5mg", "2mg", "0.05%"],
    requiresPrescription: true,
  },
  {
    id: "d065",
    dci: "Hydrocortisone",
    brands: ["Hydrocortisone Roussel"],
    category: "corticosteroid",
    forms: ["Comprimé", "Crème", "Injectable"],
    strengths: ["10mg", "1%", "100mg"],
    requiresPrescription: true,
  },
  ...
  },
  {
    id: "d069",
    dci: "Fénofibrate",
    brands: ["Lipanthyl", "Sécalip"],
    category: "lipid-lowering",
    forms: ["Gélule", "Comprimé"],
    strengths: ["145mg", "160mg", "200mg", "300mg"],
    requiresPrescription: true,
  },
  {
    id: "d070",
  ...
  },
  {
    ...
    category: "anticoagulant",
    forms: ["Injectable SC"],
    strengths: ["2000 UI", "4000 UI", "6000 UI", "8000 UI"],
    requiresPrescription: true,
  },
  {
    id: "d076",
    dci: "Digoxine",
    brands: ["Digoxine Nativelle"],
    category: "cardiac",
    forms: ["Comprimé", "Gouttes"],
    strengths: ["0.25mg"],
    requiresPrescription: true,
  ...
  },
  {
    id: "d082",
    dci: "Trinitrine",
    brands: ["Natispray", "Lénitral"],
    category: "cardiac",
    forms: ["Spray sublingual", "Patch"],
    strengths: ["0.15mg/dose", "0.30mg/dose", "5mg/24h", "10mg/24h"],
    requiresPrescription: true,
  },
  ...
  // ── Respiratory / Bronchodilators ──
  {
    ...
    forms: ["Aérosol doseur", "Nébulisation", "Sirop"],
    strengths: ["100µg/dose", "5mg/mL"],
    requiresPrescription: true,
  },
  {
    id: "d084",
    ...
    forms: ["Suspension pour nébulisation", "Aérosol"],
    strengths: ["0.5mg/2mL", "1mg/2mL", "200µg/dose"],
    requiresPrescription: true,
  },
  {
    id: "d085",
    dci: "Béclométasone",
    brands: ["Bécotide", "Qvar"],
    category: "respiratory",
    forms: ["Aérosol doseur"],
    strengths: ["50µg/dose", "100µg/dose", "250µg/dose"],
    requiresPrescription: true,
  },
  {
    id: "d086",
    ...
    brands: ["Sérétide"],
    category: "respiratory",
    forms: ["Diskus", "Aérosol"],
    strengths: ["100/50µg", "250/50µg", "500/50µg"],
    requiresPrescription: true,
  },
  {
    id: "d087",
    ...
    brands: ["Singulair"],
    category: "respiratory",
    forms: ["Comprimé", "Comprimé à croquer", "Sachet"],
  ...
  },
  {
    ...
    brands: ["Bricanyl"],
    category: "bronchodilator",
    forms: ["Comprimé", "Aérosol", "Injectable"],
    strengths: ["5mg", "500µg/dose"],
    requiresPrescription: true,
  },
  {
    id: "d091",
    ...
    brands: ["Atrovent"],
    category: "bronchodilator",
    forms: ["Aérosol", "Nébulisation"],
    strengths: ["20µg/dose", "0.25mg/mL"],
    requiresPrescription: true,
  },
  ...
  // ── Antiepileptics ──
  {
    ...
    forms: ["Comprimé", "Sirop", "Injectable"],
    strengths: ["200mg", "500mg", "500mg LP"],
    requiresPrescription: true,
  },
  {
    id: "d105",
  ...
  },
  {
    ...
    brands: ["Keppra"],
    category: "antiepileptic",
    forms: ["Comprimé", "Solution buvable", "Injectable"],
  ...
  },
  {
    ...
    brands: ["Lamictal"],
    category: "antiepileptic",
    forms: ["Comprimé", "Comprimé dispersible"],
  ...
  },
  {
    ...
    category: "antiepileptic",
    forms: ["Gélule"],
    strengths: ["25mg", "50mg", "75mg", "150mg", "300mg"],
    requiresPrescription: true,
  },
  {
    id: "d109",
  ...
  // ── Thyroid ──
  {
    id: "d110",
    dci: "Lévothyroxine",
    brands: ["Lévothyrox", "L-Thyroxine"],
    category: "thyroid",
    forms: ["Comprimé", "Solution buvable"],
    strengths: ["25µg", "50µg", "75µg", "100µg", "125µg", "150µg", "175µg", "200µg"],
    requiresPrescription: true,
  },
  {
    id: "d111",
    dci: "Carbimazole",
    brands: ["Néo-Mercazole"],
    category: "thyroid",
    forms: ["Comprimé"],
    strengths: ["5mg", "20mg"],
    requiresPrescription: true,
  ...
  },
  {
    ...
    brands: ["Nizoral"],
    category: "antifungal",
    forms: ["Comprimé", "Shampooing", "Crème"],
    strengths: ["200mg", "2%"],
    requiresPrescription: true,
  },
  {
  ...
  },
  {
    ...
    brands: ["Mycostatine"],
    category: "antifungal",
    forms: ["Suspension buvable", "Comprimé vaginal"],
    strengths: ["100 000 UI/mL"],
    requiresPrescription: true,
  },
  {
    id: "d117",
  ...
  // ── Hormones ──
  {
    ...
    brands: ["Minidril", "Trinordiol"],
    category: "hormone",
    forms: ["Comprimé"],
    strengths: ["150µg/30µg"],
    requiresPrescription: true,
  },
  {
    id: "d129",
    ...
    category: "hormone",
    forms: ["Comprimé"],
    strengths: ["3mg/0.02mg", "3mg/0.03mg"],
    requiresPrescription: true,
  },
  {
    id: "d130",
  ...
  },
  {
    id: "d131",
    dci: "Lévonorgestrel",
    brands: ["Norlevo", "Microval"],
    category: "hormone",
    forms: ["Comprimé"],
    strengths: ["1.5mg", "0.03mg"],
    requiresPrescription: true,
  },
  {
    id: "d132",
    dci: "Testostérone",
    brands: ["Androtardyl", "Nebido"],
    category: "hormone",
    forms: ["Injectable IM"],
    strengths: ["250mg/mL", "1000mg/4mL"],
    requiresPrescription: true,
  },
  ...
  // ── Ophthalmic ──
  {
    ...
    brands: ["Tobrex"],
    category: "ophthalmic",
    forms: ["Collyre", "Pommade ophtalmique"],
    strengths: ["0.3%"],
    requiresPrescription: true,
  },
  {
    id: "d134",
    dci: "Dexaméthasone Ophtalmique",
    brands: ["Maxidex"],
    category: "ophthalmic",
    forms: ["Collyre"],
    strengths: ["0.1%"],
  ...
  {
    id: "d138",
    dci: "Larmes Artificielles",
    brands: ["Refresh", "Systane", "Hyabak"],
    category: "ophthalmic",
    forms: ["Collyre"],
    strengths: ["0.15%", "0.18%"],
    requiresPrescription: false,
  ...
  // ── Supplements / Vitamins ──
  {
    ...
    brands: ["Tardyferon", "Fumafer", "Fero-Grad"],
    category: "supplement",
    forms: ["Comprimé", "Sirop"],
    strengths: ["80mg", "256mg", "105mg"],
    requiresPrescription: false,
  },
  {
    id: "d144",
    dci: "Acide Folique",
    brands: ["Spéciafoldine"],
    category: "supplement",
    forms: ["Comprimé"],
    strengths: ["0.4mg", "5mg"],
    requiresPrescription: false,
  },
  {
    ...
    brands: ["Uvédose", "ZymaD", "Adrigyl"],
    category: "supplement",
    forms: ["Ampoule buvable", "Gouttes"],
    strengths: ["100 000 UI", "200 000 UI", "10 000 UI/mL"],
    requiresPrescription: false,
  },
  {
    id: "d146",
    dci: "Calcium + Vitamine D",
    brands: ["Calcidose", "Orocal D3", "Caltrate D3"],
    category: "supplement",
    forms: ["Sachet", "Comprimé"],
    strengths: ["500mg/400UI", "1000mg/880UI"],
    requiresPrescription: false,
  },
  {
    id: "d147",
    dci: "Vitamine B12 (Cyanocobalamine)",
    brands: ["Vitamine B12 Gerda"],
    category: "supplement",
    forms: ["Comprimé", "Injectable"],
    strengths: ["250µg", "1000µg"],
    requiresPrescription: false,
  },
  {
    id: "d148",
    dci: "Magnésium + Vitamine B6",
    brands: ["Magné B6", "Mag 2"],
    category: "supplement",
    forms: ["Comprimé", "Ampoule buvable"],
    strengths: ["48mg/5mg", "100mg"],
    requiresPrescription: false,
  },
  {
    id: "d149",
    dci: "Zinc",
    brands: ["Zinc Oligosol", "Rubozinc"],
    category: "supplement",
    forms: ["Gélule", "Ampoule"],
    strengths: ["15mg"],
    requiresPrescription: false,
  },
  {
    id: "d150",
    dci: "Vitamine C (Acide Ascorbique)",
    brands: ["Laroscorbine", "Upsa C"],
    category: "supplement",
    forms: ["Comprimé effervescent", "Comprimé"],
  ...
  },
  {
    id: "d153",
    dci: "Finastéride",
    brands: ["Chibro-Proscar", "Propécia"],
    category: "urological",
    forms: ["Comprimé"],
    strengths: ["1mg", "5mg"],
    requiresPrescription: true,
  ...
  },
  {
    id: "d159",
    dci: "Quinine",
    brands: ["Quinimax", "Surquina"],
    category: "antiparasitic",
    forms: ["Comprimé", "Injectable"],
    strengths: ["300mg", "500mg"],
    requiresPrescription: true,
  },
  {
    id: "d160",
    dci: "Perméthrine",
    brands: ["Sprégal", "Lyclear"],
    category: "antiparasitic",
    forms: ["Lotion", "Crème"],
    strengths: ["1%", "5%"],
    requiresPrescription: false,
  ...
  },
  {
    ...
    brands: ["Risperdal"],
    category: "antipsychotic",
    forms: ["Comprimé", "Solution buvable", "Injectable LP"],
  ...
  },
  {
    ...
    brands: ["Zyprexa"],
    category: "antipsychotic",
    forms: ["Comprimé", "Comprimé orodispersible"],
    strengths: ["2.5mg", "5mg", "10mg", "15mg", "20mg"],
    requiresPrescription: true,
  },
  {
    id: "d164",
    dci: "Quétiapine",
    brands: ["Seroquel", "Xeroquel"],
    category: "antipsychotic",
    forms: ["Comprimé", "Comprimé LP"],
    strengths: ["25mg", "100mg", "200mg", "300mg"],
    requiresPrescription: true,
  },
  {
    id: "d165",
  ...
  // ── Antiemetics ──
  {
    ...
    brands: ["Zophren"],
    category: "antiemetic",
    forms: ["Comprimé", "Comprimé orodispersible", "Injectable"],
    strengths: ["4mg", "8mg"],
    requiresPrescription: true,
  },
  {
    ...
    brands: ["Vogalène"],
    category: "antiemetic",
    forms: ["Gélule", "Suppositoire", "Injectable"],
    strengths: ["15mg"],
    requiresPrescription: true,
  },
  ...
  },
  {
    id: "d169",
    dci: "Colchicine",
    brands: ["Colchimax", "Colchicine Opocalcium"],
    category: "other",
    forms: ["Comprimé"],
    strengths: ["0.5mg", "1mg"],
    requiresPrescription: true,
  },
  {
    id: "d170",
    dci: "Méthotrexate",
    brands: ["Novatrex", "Metoject"],
    category: "other",
    forms: ["Comprimé", "Injectable SC"],
  ...
  },
  {
    ...
    category: "antihypertensive",
    forms: ["Comprimé"],
    strengths: ["40mg", "80mg", "160mg LP"],
    requiresPrescription: true,
  },
  {
    id: "d173",
    dci: "Diosmine",
    brands: ["Daflon", "Diosmine"],
    category: "other",
    forms: ["Comprimé"],
    strengths: ["500mg", "1000mg"],
    requiresPrescription: false,
  },
  {
    id: "d174",
    dci: "Troxérutine",
    brands: ["Veinamitol", "Rhéoflux"],
    category: "other",
    forms: ["Gélule", "Sachet"],
    strengths: ["350mg", "3.5g"],
    requiresPrescription: false,
  },
  {
    id: "d175",
    dci: "Chlorhexidine",
    brands: ["Eludril", "Paroex"],
    category: "other",
    forms: ["Bain de bouche", "Gel"],
    strengths: ["0.12%", "0.2%"],
    requiresPrescription: false,
  },
  {
    ...
    brands: ["Zaditen"],
    category: "antihistamine",
    forms: ["Comprimé", "Sirop", "Collyre"],
    strengths: ["1mg", "0.25mg/mL"],
    requiresPrescription: true,
  },
  {
    id: "d177",
  ...
  },
  {
    ...
    category: "antiepileptic",
    forms: ["Comprimé", "Gouttes", "Injectable"],
    strengths: ["0.5mg", "2mg", "2.5mg/mL"],
    requiresPrescription: true,
  },
  {
    id: "d179",
    dci: "Métformine + Sitagliptine",
    brands: ["Janumet"],
    category: "antidiabetic",
    forms: ["Comprimé"],
    strengths: ["500mg/50mg", "1000mg/50mg"],
    requiresPrescription: true,
  },
  {
    id: "d180",
  ...
  {
    id: "d181",
    dci: "Périndopril + Indapamide",
    brands: ["Bipreterax", "Preterax"],
    category: "antihypertensive",
    forms: ["Comprimé"],
    strengths: ["2.5mg/0.625mg", "5mg/1.25mg", "10mg/2.5mg"],
    requiresPrescription: true,
  },
  {
    id: "d182",
    dci: "Losartan + Hydrochlorothiazide",
    brands: ["Hyzaar", "Fortzaar"],
    category: "antihypertensive",
    forms: ["Comprimé"],
    strengths: ["50mg/12.5mg", "100mg/25mg"],
    requiresPrescription: true,
  },
  {
    id: "d183",
    dci: "Bisoprolol + Hydrochlorothiazide",
    brands: ["Lodoz"],
    category: "antihypertensive",
    forms: ["Comprimé"],
    strengths: ["2.5mg/6.25mg", "5mg/6.25mg", "10mg/6.25mg"],
    requiresPrescription: true,
  },
  {
    id: "d184",
    dci: "Atorvastatine + Ézétimibe",
    brands: ["Liptruzet"],
    category: "lipid-lowering",
    forms: ["Comprimé"],
    strengths: ["10mg/10mg", "20mg/10mg", "40mg/10mg"],
    requiresPrescription: true,
  },
  {
    id: "d185",
  ...
  },
  {
    ...
    category: "gastrointestinal",
    forms: ["Comprimé", "Sirop", "Suppositoire"],
    strengths: ["100mg", "200mg", "4.8mg/mL"],
    requiresPrescription: false,
  },
  {
    id: "d188",
    ...
    brands: ["Duspatalin"],
    category: "gastrointestinal",
    forms: ["Comprimé", "Gélule LP"],
    strengths: ["135mg", "200mg LP"],
    requiresPrescription: true,
  },
  {
    id: "d189",
    dci: "Érythropoïétine",
    brands: ["Eprex", "NeoRecormon"],
    category: "other",
    forms: ["Injectable SC/IV"],
    strengths: ["1000 UI", "2000 UI", "4000 UI", "10 000 UI"],
    requiresPrescription: true,
  },
  {
    id: "d190",
    dci: "Clotrimazole",
    brands: ["Mycohydralin", "Canesten"],
    category: "antifungal",
    forms: ["Crème", "Comprimé vaginal"],
    strengths: ["1%", "500mg"],
    requiresPrescription: false,
  },
  {
    id: "d191",
    dci: "Métformone + Vildagliptine",
    brands: ["Eucreas"],
    category: "antidiabetic",
    forms: ["Comprimé"],
    strengths: ["50mg/850mg", "50mg/1000mg"],
    requiresPrescription: true,
  },
  {
    id: "d192",
    dci: "Loperamide + Siméticone",
    brands: ["Imodiumduo"],
    category: "gastrointestinal",
    forms: ["Comprimé"],
    strengths: ["2mg/125mg"],
  ...
  },
  {
    ...
    category: "other",
    forms: ["Comprimé", "Solution buvable"],
    strengths: ["800mg", "1200mg"],
    requiresPrescription: true,
  },
  {
    id: "d196",
    dci: "Bétahistine",
    brands: ["Serc", "Betaserc"],
    category: "other",
    forms: ["Comprimé"],
  ...
  },
  {
    ...
    brands: ["Exacyl"],
    category: "other",
    forms: ["Comprimé", "Injectable", "Solution buvable"],
    strengths: ["500mg", "1g"],
    requiresPrescription: true,
  },
  {
    id: "d198",
    dci: "Ciproterone + Éthinylestradiol",
    brands: ["Diane 35"],
    category: "hormone",
    forms: ["Comprimé"],
    strengths: ["2mg/0.035mg"],
    requiresPrescription: true,
  },
  {
    id: "d199",
