...
const fr: Dictionary = {
  ...
  footer: {
    ...
    columns: [
      ...
      {
        title: "Ressources",
        links: ["Documentation", "Guide de démarrage", "Statut", "Blog"],
      },
      { title: "Entreprise", links: ["À propos", "Contact", "Carrières", "Partenaires"] },
      { title: "Légal", links: ["Confidentialité", "Conditions", "Sous-traitants", "Sécurité"] },
    ],
...
const ar: Dictionary = {
  ...
  footer: {
    ...
    columns: [
      ...
      { title: "الموارد", links: ["التوثيق", "دليل البدء", "الحالة", "المدونة"] },
      { title: "الشركة", links: ["من نحن", "اتصل بنا", "وظائف", "شركاء"] },
      { title: "قانوني", links: ["الخصوصية", "الشروط", "المعالجون من الباطن", "الأمان"] },
    ],
...
const en: Dictionary = {
  ...
  footer: {
    ...
    columns: [
      ...
      { title: "Resources", links: ["Documentation", "Getting started", "Status", "Blog"] },
      { title: "Company", links: ["About", "Contact", "Careers", "Partners"] },
      { title: "Legal", links: ["Privacy", "Terms", "Sub-processors", "Security"] },
    ],
