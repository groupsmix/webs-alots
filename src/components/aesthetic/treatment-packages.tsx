    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        {showForm && (
          <Card>
            <CardHeader>
              <CardTitle className="text-sm">New Treatment Package</CardTitle>
            </CardHeader>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Skin Rejuvenation Bundle"
                    className="text-sm"
                  />
                </div>
                <div>
                  ...
                  <div className="flex items-center justify-between text-xs">
                    <div>
                      <span className="text-lg font-bold">
                        {formatNumber(pkg.price, typeof locale !== "undefined" ? locale : "fr")}
                      </span>
                    ...
                    <div className="text-right text-muted-foreground">
                      ...
                      <p className="flex items-center gap-1">
                        <Users className="h-3 w-3" /> {pkg.subscriberCount}
                      </p>
                    </div>
                  </div>
                </CardContent>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="text-right">
                        <p className="text-xs font-medium">
                          {pp.sessionsUsed}/{pp.sessionsTotal} sessions
                        </p>
