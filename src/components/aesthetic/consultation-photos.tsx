  ...
  return (
    <div className="space-y-4">
      ...
      {showForm && (
        <Card>
          <CardHeader>
            <CardTitle className="text-sm">New Consultation Photo</CardTitle>
          </CardHeader>
                    ...
                    <div className="flex items-center gap-2 text-[10px] text-muted-foreground">
                      {photo.bodyArea && (
                        <span className="flex items-center gap-0.5">
                          <MapPin className="h-2.5 w-2.5" /> {photo.bodyArea}
                        </span>
                      )}
              ...
              <Card className="w-full max-w-2xl mx-4" onClick={(e) => e.stopPropagation()}>
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-sm">
                      {selectedPhoto.patientName} — {selectedPhoto.bodyArea || "Consultation Photo"}
                    </CardTitle>
                ...
                <CardContent className="space-y-3">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Taken:{" "}
                    {formatDisplayDate(
                      new Date(selectedPhoto.takenAt),
