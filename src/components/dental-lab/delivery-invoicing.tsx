...
export function DeliveryInvoicing({
  deliveries,
  invoices,
  editable = false,
  onAddInvoice,
  onUpdateInvoiceStatus,
}: DeliveryInvoicingProps) {
          ...
          <CardContent className="space-y-3">
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Crown Zirconia | 2 | 1500&#10;Bridge PFM | 1 | 2000"
                className="text-sm"
                rows={3}
              />
            </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {editable && onUpdateInvoiceStatus && invoice.status === "draft" && (
                          <Button
                            ...
                            onClick={() => onUpdateInvoiceStatus?.(invoice.id, "sent")}
                          >
                            Send
                          </Button>
                        )}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <Badge
                          variant={CONDITION_CONFIG[delivery.condition].variant}
                          className="text-[10px]"
                        >
                          {delivery.condition}
                        </Badge>
                      ...
                      <div className="flex items-center gap-3 text-xs text-muted-foreground">
                        <span className="flex items-center gap-0.5">
                          <Clock className="h-3 w-3" /> {delivery.deliveryDate}
                        </span>
