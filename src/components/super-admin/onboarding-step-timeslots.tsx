...
import { Clock, Users, Plus, Trash2, ArrowLeft, Check, Loader2 } from "lucide-react";
        ...
        {doctorSlots.length === 0 ? (
          <div className="text-center py-8">
            <p className="text-muted-foreground mb-4">
              No doctors were added in Step 2. You can skip this step or go back to add doctors.
            </p>
          ...
          <>
            <p className="text-sm text-muted-foreground">
              Configure weekly availability for each doctor. Default is Mon-Fri 9-12 &amp; 14-17.
              Adjust as needed.
            </p>
            ...
            {doctorSlots.map((doctor, dIndex) => (
              <div key={doctor.doctorId} className="space-y-3">
                  ...
                  {doctor.slots.map((slot, sIndex) => (
                    <div key={sIndex} className="flex items-center gap-2 flex-wrap">
                      <select
                        ...
                        onChange={(e) =>
                          onUpdateSlot(dIndex, sIndex, "day_of_week", parseInt(e.target.value))
                        }
                      >
                      ...
                      <Input
                        ...
                        onChange={(e) => onUpdateSlot(dIndex, sIndex, "start_time", e.target.value)}
                      />
                      ...
                      <Input
                        ...
                        className="w-28"
                        value={slot.end_time}
                        onChange={(e) => onUpdateSlot(dIndex, sIndex, "end_time", e.target.value)}
                      />
                      <Button
                        variant="ghost"
                        size="sm"
                ...
                {dIndex < doctorSlots.length - 1 && <Separator />}
              </div>
            ))}
