...
export function AnalyticsScript({
  ...
  // A60.3 / A69-F1: Require explicit consent (=== true) before injecting any tracking.
  // Previously: `=== false` only blocked explicit opt-out, loading when prop is undefined.
  // Fixed: `!== true` blocks loading until the caller passes consentGiven={true},
  // matching the fail-safe behavior of PlausibleScript and GDPR opt-in requirements.
