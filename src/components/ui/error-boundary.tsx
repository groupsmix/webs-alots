...
export class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  override render() {
    if (this.state.hasError) {
      ...
      if (compact) {
        return (
          <div className="flex flex-col items-center justify-center rounded-lg border border-[var(--signal-red)]/20 bg-[var(--signal-red)]/5 p-4 text-center">
            <AlertTriangle className="mb-1 h-4 w-4 text-[var(--signal-red)]" />
      ...
      return (
        <div className="flex flex-col items-center justify-center rounded-xl border border-[var(--signal-red)]/20 bg-[var(--signal-red)]/5 p-8 text-center">
          <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-[var(--signal-red)]/10">
