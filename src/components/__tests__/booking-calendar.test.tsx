...
describe("BookingCalendar", () => {
  ...
  it("renders calendar with current month and year", () => {
    ...
    render(<BookingCalendar selectedDate="" onSelectDate={vi.fn()} />);
    ...
    expect(
      screen.getByText(`${monthNames[today.getMonth()]} ${today.getFullYear()}`),
    ).toBeDefined();
  });
  ...
  it("calls onSelectDate when an available date is clicked", () => {
    ...
    render(<BookingCalendar selectedDate="" onSelectDate={onSelectDate} />);
  ...
  it("highlights selected date", () => {
    ...
    render(<BookingCalendar selectedDate={dateStr} onSelectDate={vi.fn()} />);
