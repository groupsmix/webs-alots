  ...
  return (
    <div className="space-y-4">
      ...
      {showForm && (
        <Card>
          <CardHeader>
            <CardTitle className="text-sm">Add Machine</CardTitle>
          </CardHeader>
        ...
        <div className="grid gap-3 grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {machines.map((machine) => {
            ...
            const maintenanceSoon =
              machine.nextMaintenance && new Date(machine.nextMaintenance) <= sevenDaysFromNow;

            return (
              <Card key={machine.id}>
                <CardContent className="p-3">
                  <div
                    className={`flex items-center justify-center h-12 rounded-lg mb-2 ${config.bgColor}`}
                  >
                  ...
                  {maintenanceSoon && (
                    <div className="flex items-center justify-center gap-1 mt-1">
                      ...
                      <span className="text-[10px] text-[var(--signal-amber)]">
                        Maintenance soon
                      </span>
                    </div>
                  )}
