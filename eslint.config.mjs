...
// A7-05: Import custom ESLint rule to prevent authentication bypass
const require = createRequire(import.meta.url);
const noDirectSupabaseInRoutes = require("./eslint-rules/no-direct-supabase-in-routes.js");
...
const eslintConfig = defineConfig([
  ...
  ]),
  {
    plugins: {
      ...
      "custom": {
        rules: {
          "no-direct-supabase-in-routes": noDirectSupabaseInRoutes,
        },
      },
    },
    rules: {
      // A7-05: Prevent authentication bypass via direct createClient() usage in routes
      "custom/no-direct-supabase-in-routes": "error",
