...
export const logger = {
  error: (msg: string, data?: unknown) =>
    console.error(JSON.stringify({ level: "error", msg, ...((data && typeof data === 'object') ? data : { data }) })),
};
```
