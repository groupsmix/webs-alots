...
- Rotate `CRON_SECRET`, `JWT_SECRET_CURRENT`, and Stripe keys periodically
...
- `JWT_SECRET_CURRENT` / `JWT_SECRET_PREVIOUS` - JWT signing
...
### Authentication
- JWT-based with dual-secret rotation support
