...
| RISK-008 PHI key rotation       | ❌ "NOT STARTED"        | dual-key decryption in `src/lib/encryption.ts`, **tested** (`encryption.test.ts` SEC-013: encrypt-old / decrypt-after-rotation / fail-when-neither) | ✅          |
