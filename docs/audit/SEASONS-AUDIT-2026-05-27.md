...
| S0-08-04 | Info     | Tests    | `src/lib/__tests__/` (48 files)                              | Substantial coverage of `audit-log`, `auth`, `cmi-verify-callback`, `cron-auth`, `egress-allowlist`, `find-or-create-patient`, `notification-persist-clinic-id`, etc.                              | `ls src/lib/**tests**                                                   | wc -l` → 48 plus 5 integration tests.                                              | None.               | NIST SA-11 |
