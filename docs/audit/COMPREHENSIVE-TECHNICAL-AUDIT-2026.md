...
- **Production Failure Scenario:** 500 clinics * 3 staff * 2 queries/s = 3,000 QPS → pooler (100 connections) saturates → new requests fail with "connection timeout" → all tenants offline  
...
- **Assumed traffic:** 100 clinics * 10 staff * 10 requests/day = 10,000 requests/day = 300k requests/month
...
- **Savings:** ~5 min/deployment * 10 deployments/day * $100/hour engineer = $83/day = $2,500/month
- **Effort:** L (1 week)
