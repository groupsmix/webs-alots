 ...
 *                        /api/cron/retry-webhooks (failed webhook redelivery)
 ...
 *                        /api/cron/daily-briefing (daily ops briefing)
 *                        /api/cron/nps-survey    (NPS survey dispatch)
...
export const CRON_ROUTES: Record<string, string[]> = {
  ...
  "0 4 * * *": ["/api/cron/dedup-purge", "/api/cron/ai-memory-consolidate"],
  "0 5 * * *": [
    "/api/cron/stripe-reconcile",
    "/api/cron/ai-clinic-briefings",
